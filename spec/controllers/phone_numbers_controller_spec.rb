...
RSpec.describe PhoneNumbersController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      let(:valid_attributes) { { number: 'green street', contact_id: alice.id, contact_type: "Person" } }
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      let(:valid_attributes) { {number: 'red street', contact_id: bob.id, contact_type: "Person"} }
  ...
  describe "DELETE #destroy" do
    ...
    let(:valid_attributes) { {number: 'bronw street', contact_id: mike.id, contact_type: "Person"} }
